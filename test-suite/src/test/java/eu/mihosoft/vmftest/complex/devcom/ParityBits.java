...
public enum ParityBits {
    ...
    NO_PARITY(0),//SerialPort.NO_PARITY),
    EVEN_PARITY(1),//SerialPort.EVEN_PARITY),
    ODD_PARITY(2),//SerialPort.ODD_PARITY),
    MARK_PARITY(3),//SerialPort.MARK_PARITY),
    SPACE_PARITY(4);//SerialPort.SPACE_PARITY);
