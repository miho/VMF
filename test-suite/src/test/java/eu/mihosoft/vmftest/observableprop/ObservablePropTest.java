 ...
 */
package eu.mihosoft.vmftest.observableprop;
...
public class ObservablePropTest {
    ...
    public void observeSimplePropertyOfReadOnlyTest() {
        ObserveMyProperties observeMyProperties = ObserveMyProperties.newInstance();
        ReadOnlyObserveMyProperties observeMyPropertiesRO = observeMyProperties.asReadOnly();

        Property nameProperty = observeMyPropertiesRO.vmf().reflect().propertyByName("name").orElse(null);
        ...
        observeMyPropertiesRO.vmf().changes().addListener(
            (change) -> actualValues1.add((String) change.propertyChange().get().newValue())
        );
    ...
    public void observeListPropertyReadOnlyTest() {
        ...
        Property values = observeMyPropertiesRO.vmf().reflect().propertyByName("values").orElse(null);
