package eu.mihosoft.vmf.jackson.test.interfaceonly01;
...
class InterfaceOnly01ModelTest {
    @org.junit.jupiter.api.Test
    void testModel() {
        ObjectMapper mapper = new ObjectMapper();

        mapper.registerModule(VMFJacksonModule.newInstance(VMFJacksonModule.RUNTIME_TYPE.EXPERIMENTAL)
                .withTypeAlias("person", PersonBase.class.getName())
                .withTypeAlias("ordinary-person", OrdinaryPerson.class.getName())
        ...
        MyModel model = MyModel.newBuilder()
                .withPersons(OrdinaryPerson.newBuilder()
                                .withName("John Doe")
                                .withAge(30)
