...
public final class ReferenceInfo {
    ...
    private ReferenceInfo(ModelType thiz, Prop thisProp, ModelType other, Prop opposite) {
        this.thiz = thiz;
    ...
    public static ReferenceInfo newInstance(ModelType thiz, Prop thisProp, ModelType other, Prop opposite) {
        return new ReferenceInfo(thiz, thisProp, other, opposite);
    }
